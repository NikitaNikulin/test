...
<script src="{{ asset('/libs/admin/js/gmaps.js') }}"></script>

@if(isset($type) && $type == 'static')
	<div class="form-group ">
		@if(isset($size))
			<div id="map" style="width: {{ array_get($size, 0) }} !important; height: {{ array_get($size, 1) }} !important;;"></div>
		@else
			<div id="map" style="width: 600px !important; height: 220px !important;;"></div>
		@endif
	</div>
@else
